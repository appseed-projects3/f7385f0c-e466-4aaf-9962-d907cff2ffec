...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-12 21:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f7385f0c-e466-4aaf-9962-d907cff2ffec.git
$ cd f7385f0c-e466-4aaf-9962-d907cff2ffec
```
